...
carta_capital <- mongo("carta_capital", url = "mongodb://192.168.1.7:27017/news_2018")$find() %>% filter(arg >= 0, sen >= 0, val >= 0, pre >= 0, mod >= 0)
el_pais <- mongo("el_pais", url = "mongodb://192.168.1.7:27017/news_2018")$find() %>% filter(arg >= 0, sen >= 0, val >= 0, pre >= 0, mod >= 0)
estadao <- mongo("estadao", url = "mongodb://192.168.1.7:27017/news_2018")$find() %>% filter(arg >= 0, sen >= 0, val >= 0, pre >= 0, mod >= 0)
folha <- mongo("folha", url = "mongodb://192.168.1.7:27017/news_2018")$find() %>% filter(arg >= 0, sen >= 0, val >= 0, pre >= 0, mod >= 0)
gazeta_do_povo <- mongo("gazeta_do_povo", url = "mongodb://192.168.1.7:27017/news_2018")$find() %>% filter(arg >= 0, sen >= 0, val >= 0, pre >= 0, mod >= 0)
oantagonista <- mongo("oantagonista", url = "mongodb://192.168.1.7:27017/news_2018")$find() %>% filter(arg >= 0, sen >= 0, val >= 0, pre >= 0, mod >= 0)
oglobo <- mongo("oglobo", url = "mongodb://192.168.1.7:27017/news_2018")$find() %>% filter(arg >= 0, sen >= 0, val >= 0, pre >= 0, mod >= 0)
veja <- mongo("veja", url = "mongodb://192.168.1.7:27017/news_2018")$find() %>% filter(arg >= 0, sen >= 0, val >= 0, pre >= 0, mod >= 0)
...
readabilityMetrics <- mongo("readabilityMetrics", url = "mongodb://192.168.1.7:27017/news_2018")$find() %>% filter(words > 0) 
...
subj_ci = data.frame(rbind(subj_carta, subj_elpais, subj_estadao, subj_folha, subj_gazeta, subj_oantagonista, subj_oglobo, subj_veja))

subj_ci$jornal = c("Carta Capital", "El País", "Estadão", "Folha de SP", "Gazeta do Povo", "O Antagonista", "O Globo", "Veja")
```
...
subj_len = data.frame(rbind(carta_len, elpais_len, estadao_len, folha_len, gazeta_len, oantagonista_len, oglobo_len, veja_len))
subj_len$portal = c("Carta Capital", "El Pais", "Estadão", "Folha de SP","Gazeta do Povo", "O Antagonista", "O Globo", "Veja")
