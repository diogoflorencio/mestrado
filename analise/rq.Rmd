...
len_pop %>% 
  ...
  labs(title = "Relação legibilidade e popularidade",
       subtitle = "Estimativa de correlação entre legibilidade e popularidade",
       x = "", 
       y = "")
...
subj_ci %>% 
  ...
  labs(title = "Subjetividade por jornal",
       subtitle = "Estimativa de subjetividade por jornal",
       x = "", 
       y = "percentual de subjetividade") +
...
6- Existe relação entre subjetividade e tamanho do texto de uma notícia?
...
pearson_ic <- bias_pop %>% 
  bootstrap(cor(bias_news, text_size, method = "pearson"), 
            R = 2000) %>% 
    CI.percentile(probs = c(.025, .975))

spearman_ic <- bias_pop %>% 
  bootstrap(cor(bias_news, text_size, method = "spearman"), 
            R = 2000) %>% 
    CI.percentile(probs = c(.025, .975))
...
subj_len %>% 
  ...
  labs(title = "Relação subjetividade e tamanho da notícia",
       subtitle = "Estimativa de correlação entre subjetividade e tamanho da notícia, considerando um ano de coleta",
       x = "", 
       y = "") +
  theme(legend.position = "none")
```
